...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    // Doctor management: admins manage the roster, everyone
                    // authenticated can view it to book appointments
                    ...
                    // Patient records: admins and doctors can manage records,
                    // patients are restricted to their own record at the
                    // service layer (see PatientService)
                    .requestMatchers("/api/patients/**").hasAnyRole("ADMIN", "DOCTOR", "PATIENT")

                    // Appointments: any authenticated role, ownership is
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Restrict to the actual frontend origin(s) in production - do not use "*"
        // once credentials/JWT headers are involved.
